...
<link href="../assets/css/style.css" rel="stylesheet">
  ...
  <body data-spy="scroll" data-target=".navbar">
    <div id = "fullpage">
          <div id = "m-header" class = "section" style = "background-color:#3EAFC1">
                ...
                <nav class="collapse navbar-collapse" role = "navigation" id="my-navbar-collapse">
                  <div class = "navbar-inner" >
                       <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="http://localhost/ajdeguzman/forum" target = "_blank"  data-scroll="" data-options="easing: easeInQuint; speed: 800;" >FORUM</a></li>
        ...
        <section class = "section" id = "about" style = "padding-top: 100px">
        <div class = "container">
            <div class = "row text-center">
              <aside>            
                <img src="images/conan.png" width = "200" class="img-circle">
                <div class = "m-about-desc">
        ...
        <section id = "process" class = "section">
         <div>
            <h1 class = "wow flipInX animated series-banner">PROJECT WORKFLOW</h1>
            <br><br>
            <div style = "display:block">
                       <div class = "row" align = "center">
                          <div class="col-md-3">
                              <div><img alt = "Plan" src="images/processes/plan.png" width = "200" data-wow-delay="0.2s" class="wow delay-1 scale-in-anim img-responsive" ></div>
                              <div><h2 data-wow-delay="0.2s" class = "wow delay-1 fadeInUp">Plan</h2></div>
                          </div>
                          <div class="col-md-3">
                              <div><img alt = "Design" src="images/processes/design.png" data-wow-delay="0.4s" width = "200" class="wow delay-2 scale-in-anim img-responsive"></div>
                              <div><h2 data-wow-delay="0.4s" class = "wow delay-2 fadeInUp">Design</h2></div>
                          </div>
                          <div class="col-md-3">
                              <div><img alt = "Develop" src="images/processes/develop.png"data-wow-delay="0.6s" width = "200" class="wow delay-3 scale-in-anim img-responsive"></div>
                              <div><h2 data-wow-delay="0.6s" class = "wow delay-3 fadeInUp">Develop</h2></div>
                          </div>
                          <div class="col-md-3">
                              <div><img alt = "Test" src="images/processes/test.png"data-wow-delay="0.8s" width = "200" class="wow delay-4 scale-in-anim img-responsive"></div>
        ...
        <section id = "blog" class = "section">
          <div class = "container">
            <h1 class = "wow flipInX animated series-banner">BLOG</h1>
            <br><br>
              <div class = "container">
                       <div class = "row" align = "center">
                          <div class = "col-sm-6 col-md-4">
                            <div class="thumbnail">
                                <a href="#" class="wow delay-4 scale-in-anim">
                                  <img src="http://placehold.it/350x192/449955/FFF">
                                </a>
                              <div class="caption">
        ...
        <section id = "detailed-portfolio" class = "section">
          <div class = "container">
            <div class = "row">
        ...
        <section id = "portfolio" class = "section">
          <div class = "container">
            <h1 class = "wow flipInX animated series-banner">RECENT WORK</h1>
            <br><br>
            <div class = "col-md-12">
                <div class = "row">
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="images/portfolio/myccs_thumb.png" alt="">
                        <div class="caption">
                          <h4 class = "text-left">MyCCS</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="images/portfolio/jepoy.png" alt="">
                        <div class="caption">
                          <h4 class = "text-left">Jepoy Caoile Photography (WIP)</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="images/portfolio/mysrp_thumb.png" alt="">
                        <div class="caption">
                          <h4 class = "text-left">My Students' Portal</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="images/portfolio/aljanix_thumb.png" alt="">
                        <div class="caption">
                          <h4 class = "text-left">Aljanix Website</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="images/portfolio/thumb_debtnote.png" alt="">
                        <div class="caption">
                          <h4 class = "text-left">Debt Note</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                    <div class = "col-sm-6 col-md-4">
                      <div class="thumbnail">
                        <img width = "350px" height = "192px" src="http://placehold.it/350x192/449955/FFF" alt="">
                        <div class="caption">
                          <h4 class = "text-left">Pocket Load Toolkit</h4>
                          <p class = "text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                        </div>
                      </div>
                    </div>
                          <a href="#" class="btn btn-large">VIEW ALL WORKS</a>
            </div>
          </div>
        </section>
        <section id = "contact" class = "section">
          <div class = "container form-group">
            <h1 class = "wow flipInX animated series-banner">GET IN TOUCH</h1>
            <h2 class = "wow fadeInUp">Feel free to send me a message if you have any question.</h2>
            <h2 class = "wow fadeInUp"> I'd love to hear from you.</h2>
            <br><br>
            <div class = "row">
              <div class="col-md-8 text-left wow bounceInLeft">
                   <div align = "center">
                    <form name="first_form" role="form" method="post" action=""> 
                        <div class="row">
                              <label class = "col-md-2"></label>
                                  <div>
                                      <input type="text" placeholder = "Name" class="form-control m-frm-textinput col-md-5" name="sender_name" value="">
                                  </div>
                        </div><br>
                        <div class="row">
                              <label class = "col-md-2"></label>
                                  <div>
                                      <input type="email" placeholder = "Email" class="form-control m-frm-textinput col-md-5" name="sender_email" value="">
                                  </div>
                        </div><br>
                        <div class="row">
                              <label class = "col-md-2"></label>
              ...
              <div class="col-md-4 text-left wow bounceInRight"> 
                 <div id="map_canvas">
                  </div>
                  <br>
                  <div class="details">
                    <strong><i class="fa fa-map-marker"></i> Address</strong>
                    <p>Unit 17, A. Flores St., Bagong Ilog <br> Pasig City, Metro Manila <br>Philippines 1600</p>
                    <hr class="dotted">
                    <strong><i class="fa fa-envelope"></i> Email</strong>
                    <p><a href="mailto:aljohndeguzman@gmail.com">aljohndeguzman@gmail.com</a></p>
                    <hr class="dotted">
